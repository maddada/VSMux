import{a as e,n as t}from"./chunk-BneVvdWh.js";import{n,t as r}from"./iframe-D3MQgCEY.js";import{a as i,i as a,n as o,o as s,r as c,t as l}from"./sidebar-story-workspace-BS6zh4-W.js";import{i as u,n as d,o as f,s as p,t as m}from"./sidebar-story-meta-CCC66m2m.js";import{n as h,t as g}from"./workspace-app-DKUyd1-Y.js";function _({debuggingMode:e=!1,message:t}){let[n,r]=(0,D.useState)(()=>o(t)),s=(0,D.useRef)(n),c=(0,D.useRef)(w()).current,u=(0,D.useRef)(w()).current,d=e=>{let t=a(s.current,e);t&&(0,D.startTransition)(()=>{r(t)})},f=(0,D.useMemo)(()=>({postMessage(e){d(e)}}),[]),p=(0,D.useMemo)(()=>({postMessage(e){let t=T(e);t&&d({sessionId:t.sessionId,type:`focusSession`})}}),[]);return(0,D.useEffect)(()=>{s.current=n},[n]),(0,D.useEffect)(()=>{(0,D.startTransition)(()=>{r(o(t))})},[t]),(0,D.useEffect)(()=>{let t=l(n),r=v(n,e),i=window.setTimeout(()=>{C(c,t),C(u,r)},0);return()=>{window.clearTimeout(i)}},[e,c,n,u]),(0,O.jsxs)(`div`,{style:{boxSizing:`border-box`,display:`grid`,gap:`16px`,gridTemplateColumns:`170px minmax(0, 1fr)`,height:`100vh`,padding:`16px`},children:[(0,O.jsx)(`div`,{style:{minHeight:0,overflow:`auto`},children:(0,O.jsx)(i,{messageSource:c,vscode:f})}),(0,O.jsx)(`div`,{style:{minHeight:0,overflow:`hidden`},children:(0,O.jsx)(g,{messageSource:u,vscode:p})})]})}function v(e,t){let n=l(e),r=n.groups.find(e=>e.isActive)??n.groups[0],i=r?.sessions.find(e=>e.isFocused)?.sessionId,a=new Map((r?.sessions??[]).map(e=>[e.sessionId,e])),o=(e.snapshot.groups.find(t=>t.groupId===e.snapshot.activeGroupId)?.snapshot.visibleSessionIds??[]).map(e=>a.get(e)).filter(e=>e!==void 0&&e.isVisible).map(e=>({isVisible:!0,kind:`terminal`,sessionId:e.sessionId,sessionRecord:{alias:e.alias,column:e.column,createdAt:new Date(0).toISOString(),displayId:x(e.shortcutLabel),kind:`terminal`,row:e.row,sessionId:e.sessionId,slotIndex:S(e.shortcutLabel),title:e.primaryTitle??e.alias},snapshot:y(e.sessionId),terminalTitle:e.terminalTitle}));return{activeGroupId:e.snapshot.activeGroupId,connection:k,debuggingMode:t,focusedSessionId:i,layoutAppearance:{activePaneBorderColor:`rgba(90, 134, 255, 0.95)`,paneGap:12},panes:o,terminalAppearance:{cursorBlink:!0,cursorStyle:`bar`,fontFamily:`"MesloLGL Nerd Font Mono", Menlo, Monaco, "Courier New", monospace`,fontSize:12,letterSpacing:0,lineHeight:1},type:`hydrate`,viewMode:r?.viewMode??`grid`,visibleCount:r?.visibleCount??1,workspaceSnapshot:e.snapshot}}function y(e){return{agentName:`OpenAI Codex`,agentStatus:`idle`,cols:120,cwd:`/Users/madda/dev/_active/agent-tiler`,history:b(e),isAttached:!0,restoreState:`live`,rows:34,sessionId:e,shell:`/bin/zsh`,startedAt:new Date(0).toISOString(),status:`running`,workspaceId:`storybook-workspace`}}function b(e){return[`\x1B[38;2;145;203;255mdev/_active/agent-tiler\x1B[0m `,`\u001b[38;2;255;216;115m${e}\u001b[0m`,`\r
...
`,`$ `].join(``)}function x(e){let t=e.match(/(\d+)$/)?.[1];return t?t.padStart(2,`0`):`00`}function S(e){let t=e.match(/(\d+)$/)?.[1],n=t?Number.parseInt(t,10):NaN;return Number.isFinite(n)&&n>0?n:1}function C(e,t){e.dispatchEvent(new MessageEvent(`message`,{data:t}))}function w(){return new EventTarget}function T(e){return E(e)&&e.type===`focusSession`&&typeof e.sessionId==`string`?{sessionId:e.sessionId,type:`focusSession`}:void 0}function E(e){return typeof e==`object`&&!!e}var D,O,k,A=t((()=>{D=e(n()),s(),c(),h(),O=r(),k={baseUrl:`ws://127.0.0.1:0`,mock:!0,token:`storybook`,workspaceId:`storybook-workspace`},_.__docgenInfo={description:``,methods:[],displayName:`WorkspaceStoryHarness`,props:{debuggingMode:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},message:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{
...
}`,...P.parameters?.docs?.source}}},F=[`Default`,`SplitFocusDebug`]}))();export{N as Default,P as SplitFocusDebug,F as __namedExportsOrder,M as default};