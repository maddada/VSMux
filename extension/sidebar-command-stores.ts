...
const GLOBAL_SIDEBAR_COMMANDS_KEY = "VSmux.globalSidebarCommands";
const GLOBAL_SIDEBAR_COMMAND_ORDER_KEY = "VSmux.globalSidebarCommandOrder";
const GLOBAL_DELETED_DEFAULT_COMMANDS_KEY = "VSmux.globalDeletedSidebarDefaultCommands";
const SHARED_SIDEBAR_COMMANDS_KEY_PREFIX = "VSmux.sharedSidebarCommands";
const SHARED_SIDEBAR_COMMAND_ORDER_KEY_PREFIX = "VSmux.sharedSidebarCommandOrder";
const SHARED_DELETED_DEFAULT_COMMANDS_KEY_PREFIX = "VSmux.sharedDeletedSidebarDefaultCommands";

export const SHARED_SIDEBAR_COMMANDS_MIGRATION_KEY_PREFIX = "VSmux.sharedSidebarCommandsMigration";
